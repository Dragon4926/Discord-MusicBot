...
module.exports = {
    name: 'controller',
    description: "Simply create a music-commands channel ",
    voiceChannel: false,
    ...
    async execute({ inter, client }) { 
      ...
      const embed = new EmbedBuilder()
       ...
       .setColor('#36393e')
       .setFooter({ text: 'Hope you have a great day', iconURL: inter.member.avatarURL({ dynamic: true })})


         inter.reply({ content: `Bot has been set to ${Channel}...Head there for the commands to work ✅`, ephemeral: true})
